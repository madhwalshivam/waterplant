...
import plant3 from "../assets/banner machine.jpg";
...
const cards = [
  ...
  {
    title: "Enagic Kangen Water Machine",
    description:
      "Hydro X Water Treatment Pvt. Ltd. is committed to the transformation of water purification with innovative solutions. As one of the Top Enagic Kangen Water Machine Manufacturers in Delhi, we provide systems that turn ordinary tap water into health-boosting alkaline water.",
    image: plant3,
    delay: 0.5,
  },
];

const PopularIozined = () => {
  return (
